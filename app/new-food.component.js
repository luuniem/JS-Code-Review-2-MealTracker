    ...
    return {
        ...
        execute: function() {
            NewFoodComponent = (function () {
                ...
                NewFoodComponent.prototype.createFood = function (userName, userLog, userCalories) {
                    var newFood = new food_model_1.Food(userName.value, userLog.value, parseInt(userCalories.value));
